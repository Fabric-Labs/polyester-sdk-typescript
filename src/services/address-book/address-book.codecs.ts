...
export const AccountScopeTypeCodec = {
    ...
    protoToOutput: {
        [Proto.AccountScopeType.SCOPE_UNSPECIFIED]: "unspecified",
...
export const AddressBookEntryKindCodec = {
    ...
    protoToOutput: {
        [Proto.AddressBookEntryKind.ENTRY_KIND_UNSPECIFIED]: "unspecified",
...
export const DestinationWhitelistStatusCodec = {
    protoToOutput: {
        [Proto.DestinationWhitelistStatus.DESTINATION_WHITELIST_STATUS_UNSPECIFIED]: "unspecified",
