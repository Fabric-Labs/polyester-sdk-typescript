...
export type AssetBalance = Message<"ledger.read.v1.AssetBalance"> & {
   ...
   *
   * @generated from field: uint64 trading_version = 6;
   */
  tradingVersion: bigint;
   ...
   * and smaller is stale. Equal revisions with different values are invalid.
   *
   * @generated from field: uint64 funding_version = 7;
   */
   ...
   * and smaller is stale. Equal revisions with different values are invalid.
   *
   * @generated from field: uint64 reserved_version = 8;
   */
